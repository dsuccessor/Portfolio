            ...
            <div className="container mb-3 border-light port-shadow-8">
              <div className="row justify-content-evenly">
                ...
                {data?.getMedias?.map((item, index) => {
                  return (
                    <div
                      className="col-11 col-md-8 col-lg-5 mx-2 my-3 bg-primary border-light port-shadow-8"
                      key={index}
                    >
                      <div className="row">
                        ...
                        <div className="col-7 text-primary bg-white">
                          <div className="row justify-content-center">
                            <div className="col my-4">
                              <h2 className="fs-5 card-title text-start ms-md-4 ps-md-4 mb-1">
                                SALAUDEEN K.R
                              </h2>
                              <div className="ps-2 ms-3">
                                <h3 className="fs-6 text-start text-dark ps-md-1 ms-md-2 my-2 fw-light">
                                  Sofware Engineer
                                </h3>
