...
import { GET_SKILLS } from "../../query/portfolioQueries";
        ...
        <div className="row text-start align-items-center">
            ...
            {data?.getSkills?.map((item) => {
              ...
              <div className="col" key={item?.id}>
                <div className="text-center mt-4">
                  ...
                  <div className="mt-3">
                    <h6 className="nav-link m-0 text-primary">{item?.name}</h6>
                  </div>
                </div>
              </div>
                )
          ...
          {data?.getSkills?.map((item) => {
            ...
            <div className="row mb-3" key={item?.id}>
              ...
              <div className="col-4">
                <h5 className="nav-link text-muted text-end">{item?.name}</h5>
              </div>
            </div>
                )
          })
